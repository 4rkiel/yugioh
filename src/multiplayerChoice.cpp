...
/******************************************************************************
	...
	Une fois le choix multiplayer réalisé: il y aura bien quelque chose a faire
...
MultiPlayerChoice::MultiPlayerChoice () {
    ...
    layout -> setMargin(0);
        ...
        info = new QLabel ("Partie Multijoueur");
...
void MultiPlayerChoice::init (){
//    local -> setFocus();
}



void MultiPlayerChoice::emitChoice (){
    emit choiceStack();
}
