...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Thu Feb 22 15:41:27 2018
# Project:  yugioh.pro
# Template: app
...
SOURCES       = app.cpp \
		...
		deckBuilding/carte_monstre.cpp moc_app.cpp \
		moc_generique.cpp \
		moc_genProgress.cpp \
		moc_intro.cpp \
		moc_main.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/yugioh1.0.0/ && $(COPY_FILE) --parents app.h generique.h genProgress.h intro.h main.h shadowButt.h sleeper.h deckBuilding/deck.h deckBuilding/carte.h deckBuilding/carte_monstre.h .tmp/yugioh1.0.0/ && $(COPY_FILE) --parents app.cpp generique.cpp genProgress.cpp intro.cpp main.cpp shadowButt.cpp deckBuilding/deck.cpp deckBuilding/carte.cpp deckBuilding/carte_monstre.cpp .tmp/yugioh1.0.0/ && (cd `dirname .tmp/yugioh1.0.0` && $(TAR) yugioh1.0.0.tar yugioh1.0.0 && $(COMPRESS) yugioh1.0.0.tar) && $(MOVE) `dirname .tmp/yugioh1.0.0`/yugioh1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/yugioh1.0.0
