...
# Generated by qmake (2.01a) (Qt 4.8.7) on: lun. mars 19 12:45:22 2018
# Project:  yugioh.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/yugioh1.0.0/ && $(COPY_FILE) --parents inc/field.h inc/appIndicator.h inc/slotCard.h inc/generique.h inc/genProgress.h inc/intro.h inc/choice.h inc/main.h inc/buildtab.h inc/optab.h inc/ruletab.h inc/helptab.h inc/shadowButt.h inc/sleeper.h obj/yugioh1.0.0/ && $(COPY_FILE) --parents src/field.cpp src/appIndicator.cpp src/slotCard.cpp src/generique.cpp src/genProgress.cpp src/intro.cpp src/choice.cpp src/main.cpp src/buildtab.cpp src/optab.cpp src/ruletab.cpp src/helptab.cpp src/shadowButt.cpp obj/yugioh1.0.0/ && (cd `dirname obj/yugioh1.0.0` && $(TAR) yugioh1.0.0.tar yugioh1.0.0 && $(COMPRESS) yugioh1.0.0.tar) && $(MOVE) `dirname obj/yugioh1.0.0`/yugioh1.0.0.tar.gz . && $(DEL_FILE) -r obj/yugioh1.0.0
...
obj/moc_appIndicator.cpp: inc/appIndicator.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) inc/appIndicator.h -o obj/moc_appIndicator.cpp
