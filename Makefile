...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/yugioh1.0.0/ && $(COPY_FILE) --parents inc/buildtab.h inc/choice.h inc/field.h inc/generique.h inc/genProgress.h inc/helptab.h inc/intro.h inc/main.h inc/optab.h inc/ruletab.h inc/zButt.h inc/shadowButt.h inc/shadowLab.h inc/duplica.h inc/sleeper.h inc/slotCard.h inc/editeur_de_carte.h obj/yugioh1.0.0/ && $(COPY_FILE) --parents src/buildtab.cpp src/choice.cpp src/field.cpp src/generique.cpp src/genProgress.cpp src/helptab.cpp src/intro.cpp src/main.cpp src/optab.cpp src/ruletab.cpp src/zButt.cpp src/shadowButt.cpp src/shadowLab.cpp src/duplica.cpp src/slotCard.cpp src/editeur_de_carte.cpp obj/yugioh1.0.0/ && (cd `dirname obj/yugioh1.0.0` && $(TAR) yugioh1.0.0.tar yugioh1.0.0 && $(COMPRESS) yugioh1.0.0.tar) && $(MOVE) `dirname obj/yugioh1.0.0`/yugioh1.0.0.tar.gz . && $(DEL_FILE) -r obj/yugioh1.0.0
