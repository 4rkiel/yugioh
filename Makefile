...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/yugioh1.0.0/ && $(COPY_FILE) --parents app.h appIndicator.h card.h generique.h genProgress.h intro.h main.h shadowButt.h sleeper.h .tmp/yugioh1.0.0/ && $(COPY_FILE) --parents app.cpp appIndicator.cpp card.cpp generique.cpp genProgress.cpp intro.cpp main.cpp shadowButt.cpp .tmp/yugioh1.0.0/ && (cd `dirname .tmp/yugioh1.0.0` && $(TAR) yugioh1.0.0.tar yugioh1.0.0 && $(COMPRESS) yugioh1.0.0.tar) && $(MOVE) `dirname .tmp/yugioh1.0.0`/yugioh1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/yugioh1.0.0
